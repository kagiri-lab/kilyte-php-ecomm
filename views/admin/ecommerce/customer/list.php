            ...
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                ...
                <tbody class="list" id="table-customers-body">
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="name align-middle white-space-nowrap py-2"><a href="/admin/customer/get/1">
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="name align-middle white-space-nowrap py-2"><a href="/admin/customer/get/1">
                                <div class="d-flex d-flex align-items-center">
                                    <div class="avatar avatar-xl me-2">
                                        <img class="rounded-circle" src="/assets/admin/img/team/4.jpg" alt="" />
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="name align-middle white-space-nowrap py-2"><a href="/admin/customer/get/1">
                                <div class="d-flex d-flex align-items-center">
                                    <div class="avatar avatar-xl me-2">
                                        <img class="rounded-circle" src="/assets/admin/img/team/13.jpg" alt="" />
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="name align-middle white-space-nowrap py-2"><a href="/admin/customer/get/1">
                                <div class="d-flex d-flex align-items-center">
                                    <div class="avatar avatar-xl me-2">
                                        <img class="rounded-circle" src="/assets/admin/img/team/9.jpg" alt="" />
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="name align-middle white-space-nowrap py-2"><a href="/admin/customer/get/1">
                                <div class="d-flex d-flex align-items-center">
                                    <div class="avatar avatar-xl me-2">
                                        <img class="rounded-circle" src="/assets/admin/img/team/14.jpg" alt="" />
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="name align-middle white-space-nowrap py-2"><a href="/admin/customer/get/1">
                                <div class="d-flex d-flex align-items-center">
                                    <div class="avatar avatar-xl me-2">
                                        <img class="rounded-circle" src="/assets/admin/img/team/5.jpg" alt="" />
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="name align-middle white-space-nowrap py-2"><a href="/admin/customer/get/1">
                                <div class="d-flex d-flex align-items-center">
                                    <div class="avatar avatar-xl me-2">
                                        <img class="rounded-circle" src="/assets/admin/img/team/6.jpg" alt="" />
