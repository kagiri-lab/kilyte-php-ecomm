        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tp-bnd owl-carousel">
                    <div class="bnd-items">
                        <a href="#"><img src="/assets/shop/images/brand-01.png" alt="" class="img-fluid" /></a>
                    </div>
                    <div class="bnd-items">
                        <a href="#"><img src="/assets/shop/images/brand-02.png" alt="" class="img-fluid" /></a>
                    </div>
                    <div class="bnd-items">
                        <a href="#"><img src="/assets/shop/images/brand-03.png" alt="" class="img-fluid" /></a>
                    </div>
                    <div class="bnd-items">
                        <a href="#"><img src="/assets/shop/images/brand-04.png" alt="" class="img-fluid" /></a>
                    </div>
                    <div class="bnd-items">
                        <a href="#"><img src="/assets/shop/images/brand-05.png" alt="" class="img-fluid" /></a>
                    </div>
                    <div class="bnd-items">
                        <a href="#"><img src="/assets/shop/images/brand-06.png" alt="" class="img-fluid" /></a>
                    </div>
                    <div class="bnd-items">
                        <a href="#"><img src="/assets/shop/images/brand-07.png" alt="" class="img-fluid" /></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="footer-btm">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <p>Copyright &copy; <?= date("Y") ?> | <?= $this->title ?></p>
            </div>
            <div class="col-md-6 text-right">
                <img src="/assets/shop/images/payment.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
    <div class="back-to-top text-center">
        <img src="/assets/shop/images/backtotop.png" alt="" class="img-fluid">
    </div>
</section>
<!-- End Footer Area -->
